...
const Home = ({ className }) => {
  return (
    <>
      <div className="flex h-[calc(100vh-52px)] sm:h-[calc(100vh-60px)]">
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
          ...
          <div className="flex-1 flex flex-col gap-1.5 sm:gap-2 md:gap-4 p-1 sm:p-2 md:p-4 min-h-0 overflow-y-auto">
            <section
              className={`relative flex-1 min-h-[200px] flex items-center justify-center overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl ${className || ""}`}
            >
              <Image
                src={heroImage}
                alt="Hero background"
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3 md:gap-4 shrink-0">
              <div className="bg-sp-green-dark rounded-md sm:rounded-lg md:rounded-xl p-2 sm:p-3 md:p-4">
                <div className="relative rounded-md sm:rounded-lg md:rounded-xl overflow-hidden min-h-[140px] sm:min-h-[160px] md:min-h-[180px] flex justify-center items-center p-3 sm:p-4 md:p-6">
                  <Image
                    src={bikeImage}
      ...
      <section className="bg-black text-white p-3 sm:p-4 md:p-6 lg:p-8 mx-1 mt-1.5 sm:mt-2 md:mt-4 sm:mx-2 md:mx-4 rounded-md sm:rounded-lg md:rounded-xl">
