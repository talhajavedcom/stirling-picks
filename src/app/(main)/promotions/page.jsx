                  ...
                  <div className="absolute inset-y-0 left-0 w-[55%] z-10 p-7 flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-white/35 text-[8.5px] leading-tight max-w-[180px]">
                        As a Official Global Partner with Many Renowned Sports
                        Stars. Bet on Matches On a Regular Occasion Throughout
                        The Season
                      </p>
                    </div>
                  </div>
                ...
                <div className="relative rounded-3xl overflow-hidden h-[220px] bg-[#1a3a2e] border border-[#00ff87]/20 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,255,135,0.2)]">
                  <div className="absolute inset-y-0 left-0 w-[55%] z-10 p-7 flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-white/35 text-[8.5px] leading-tight max-w-[180px]">
                        Open PRO Account, 1 opt-ins customer offer. Rewards:
                        Free Bingo. Free Bet. Free Spins, Double Odds. Valid for
                        7 days. Guaranteed Reward on Supercharged Days. Reward
                  ...
                  <div className="absolute inset-y-0 left-0 w-[50%] z-10 p-7 flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-white/35 text-[8.5px] leading-tight max-w-[220px]">
                        Certain deposit methods & bet types excl. Min Bet £10.
                        Odds excl. Acca odds of account min of min odds. 1/2 to
                        get 4. £0.21 free spin, free bets 3+ bonus max £120.
                        Multiple sportsbook markets only. Free bets valid for 7
                        days, stake not returned. Restrictions + T&Cs apply.
                      </p>
                    </div>
                  </div>
                  <div
                ...
                <div className="relative rounded-3xl overflow-hidden h-[220px] bg-[#1a3a2e] border border-[#00ff87]/20 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,255,135,0.2)]">
                  <div className="absolute inset-y-0 left-0 w-[50%] z-10 p-7 flex flex-col justify-between">
                    ...
                    <div>
                      ...
                      <p className="text-white/35 text-[8.5px] leading-tight max-w-[220px]">
                        Max boost limits may apply. Some deposit types, markets
                        & bet types excl. T&Cs apply. PLEASE BET RESPONSIBLY.
                        For support and information see GambleAware.co
                      </p>
                    </div>
                  </div>
                  <div
